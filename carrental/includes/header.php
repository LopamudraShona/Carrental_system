...
<header>
  <div class="default-header" style="padding:15px 0;">
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/logo2.png"  alt="image" style="width:80px;height:60px;"/></a> </div>
        </div>
