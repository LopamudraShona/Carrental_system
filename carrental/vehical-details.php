...
//File Upload block code
$uploadDir = "uploads/";
$fileName = $_FILES["uploadfile"]["name"];
$fileTmpName = $_FILES["uploadfile"]["tmp_name"];
$fileSize = $_FILES["uploadfile"]["size"];
$fileExt = strtolower(pathinfo($fileName, PATHINFO_EXTENSION));
$allowedExt = array("jpg", "jpeg", "pdf");

if(in_array($fileExt, $allowedExt) && $fileSize < 2 * 1024 * 1024) { // 2MB limit
    ...
    echo "<script>alert('Only PDF and JPG files under 2MB are allowed.');</script>";
    exit;
}
  ...
  if ($query1->rowCount() == 0) {
    ...
    $sql = "INSERT INTO  tblbooking(BookingNumber,userEmail,VehicleId,FromDate,ToDate,message,Status,Document) VALUES(:bookingno,:useremail,:vhid,:fromdate,:todate,:message,:status,:document)";
    ...
    $query->bindParam(':document', $newFileName, PDO::PARAM_STR);
    $query->execute();
        ...
        <aside class="col-md-3">
          ...
          <div class="sidebar_widget">
            ...
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label>Upload License / Document (PDF/JPG only):</label>
                <input type="file" class="form-control" name="uploadfile" accept=".pdf,.jpg,.jpeg" required>
              </div>
