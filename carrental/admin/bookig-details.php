...
tblbooking.FromDate, tblbooking.ToDate, tblbooking.message, tblbooking.VehicleId as vid, 
tblbooking.Status, tblbooking.PostingDate, tblbooking.id, tblbooking.BookingNumber, 
tblbooking.document,  -- added line
														...
														<tr>
															...
															<td colspan="3">
																<?php if (!empty($result->document)) { ?>
																	<a href="../uploads/<?php echo htmlentities($result->document); ?>"
																		target="_blank">
																		View Document
																	</a>
																<?php } else { ?>
